...
#define FCML_SYSV_SVR32_COMPATIBLE   0x00020000

/* Do not invert operands.*/
#define FCML_DO_NOT_INVERT_OPERANDS  0x00040000
...
fcml_st_dialect_mnemonic fcml_arr_dialect_gas_mnemonics[] = {
    ...
    { FCML_TEXT("bound"), FCML_ASM_DIALECT_INSTRUCTION(F_BOUND, FCML_AM_ALL), FCML_DO_NOT_INVERT_OPERANDS },
    ...
    { FCML_TEXT("cmpsw[tb,ow,sf];cmpsl[tb,od,sf];cmpsq[tb,oq,sf]"), FCML_ASM_DIALECT_INSTRUCTION(F_CMPS, FCML_AM_MO_MO), 0 },
    ...
    { FCML_TEXT("endbr64"), FCML_ASM_DIALECT_INSTRUCTION(F_ENDBR64, FCML_AM_ALL), 0 },
    ...
    { FCML_TEXT("cvtsi2sdl[sf,od]"), FCML_ASM_DIALECT_INSTRUCTION(F_CVTSI2SD, FCML_AM_RX_RM32), 0 },
    { FCML_TEXT("cvtsi2sdq[sf,oq]"), FCML_ASM_DIALECT_INSTRUCTION(F_CVTSI2SD, FCML_AM_RX_RM64), 0 },
    { FCML_TEXT("vcvtsi2sdl[sf,od]"), FCML_ASM_DIALECT_INSTRUCTION(F_VCVTSI2SD, FCML_AM_RX_RX_RM32), 0 },
    { FCML_TEXT("vcvtsi2sdq[sf,oq]"), FCML_ASM_DIALECT_INSTRUCTION(F_VCVTSI2SD, FCML_AM_RX_RX_RM64), 0 },
    { FCML_TEXT("cvtsi2ssl[sf,od]"), FCML_ASM_DIALECT_INSTRUCTION(F_CVTSI2SS, FCML_AM_RX_RM32), 0 },
    { FCML_TEXT("cvtsi2ssq[sf,oq]"), FCML_ASM_DIALECT_INSTRUCTION(F_CVTSI2SS, FCML_AM_RX_RM64), 0 },
    { FCML_TEXT("vcvtsi2ssl[sf,od]"), FCML_ASM_DIALECT_INSTRUCTION(F_VCVTSI2SS, FCML_AM_RX_RX_RM32), 0 },
    { FCML_TEXT("vcvtsi2ssq[sf,oq]"), FCML_ASM_DIALECT_INSTRUCTION(F_VCVTSI2SS, FCML_AM_RX_RX_RM64), 0 },
    ...
    { FCML_TEXT("vcvttpd2dq[l2];vcvttpd2dqx[l0];vcvttpd2dqy[l1]"), FCML_ASM_DIALECT_INSTRUCTION(F_VCVTTPD2DQ, FCML_AM_ALL), 0 },
    ...
    { FCML_TEXT("dec;decb[sb]"), FCML_ASM_DIALECT_INSTRUCTION(F_DEC, FCML_AM_RM8), 0 },
    { FCML_TEXT("dec;decw[ow,sf];decl[od,sf];decq[oq,sf]"), FCML_ASM_DIALECT_INSTRUCTION(F_DEC, FCML_AM_RMO), 0 },
    { FCML_TEXT("dec"), FCML_ASM_DIALECT_INSTRUCTION(F_DEC, FCML_AM_RO), 0 },
    ...
    { FCML_TEXT("enter;enterq"), FCML_ASM_DIALECT_INSTRUCTION(F_ENTER, FCML_AM_ALL), FCML_DO_NOT_INVERT_OPERANDS },
    ...
    { FCML_TEXT("fadds[d04]"), FCML_ASM_DIALECT_INSTRUCTION(F_FADD, FCML_AM_M32), 0 },
    { FCML_TEXT("faddl[d08]"), FCML_ASM_DIALECT_INSTRUCTION(F_FADD, FCML_AM_M64), 0 },
    ...
    { FCML_TEXT("fdivr"), FCML_ASM_DIALECT_INSTRUCTION(F_FDIV, FCML_AM_ST_ST0), FCML_SYSV_SVR32_COMPATIBLE },
    ...
    { FCML_TEXT("fdivrp"), FCML_ASM_DIALECT_INSTRUCTION(F_FDIVP, FCML_AM_ALL), FCML_SYSV_SVR32_COMPATIBLE },
    ...
    { FCML_TEXT("fdiv"), FCML_ASM_DIALECT_INSTRUCTION(F_FDIVR, FCML_AM_ST_ST0), FCML_SYSV_SVR32_COMPATIBLE },
    { FCML_TEXT("fdivrp"), FCML_ASM_DIALECT_INSTRUCTION(F_FDIVRP, FCML_AM_ALL), 0 },
    { FCML_TEXT("fdivp"), FCML_ASM_DIALECT_INSTRUCTION(F_FDIVRP, FCML_AM_ALL), FCML_SYSV_SVR32_COMPATIBLE },
    ...
    { FCML_TEXT("fsubr"), FCML_ASM_DIALECT_INSTRUCTION(F_FSUB, FCML_AM_ST_ST0), FCML_SYSV_SVR32_COMPATIBLE },
    { FCML_TEXT("fsubp"), FCML_ASM_DIALECT_INSTRUCTION(F_FSUBP, FCML_AM_ALL), 0 },
    { FCML_TEXT("fsubrp"), FCML_ASM_DIALECT_INSTRUCTION(F_FSUBP, FCML_AM_ALL), FCML_SYSV_SVR32_COMPATIBLE },
    ...
    { FCML_TEXT("fsub"), FCML_ASM_DIALECT_INSTRUCTION(F_FSUBR, FCML_AM_ST_ST0), FCML_SYSV_SVR32_COMPATIBLE },
    { FCML_TEXT("fsubrp"), FCML_ASM_DIALECT_INSTRUCTION(F_FSUBRP, FCML_AM_ALL), 0 },
    { FCML_TEXT("fsubp"), FCML_ASM_DIALECT_INSTRUCTION(F_FSUBRP, FCML_AM_ALL), FCML_SYSV_SVR32_COMPATIBLE },
    ...
    { FCML_TEXT("idiv;idivb[sb]"), FCML_ASM_DIALECT_INSTRUCTION(F_IDIV, FCML_AM_RM8), 0 },
    { FCML_TEXT("idiv;idivw[sf,ow];idivl[sf,od];idivq[sf,oq]"), FCML_ASM_DIALECT_INSTRUCTION(F_IDIV, FCML_AM_RMO), 0 },
    { FCML_TEXT("imul;imulb[sb]"), FCML_ASM_DIALECT_INSTRUCTION(F_IMUL, FCML_AM_RM8), 0 },
    ...
    { FCML_TEXT("inc;incb[sb]"), FCML_ASM_DIALECT_INSTRUCTION(F_INC, FCML_AM_RM8), 0 },
    { FCML_TEXT("inc;incw[sf,ow];incl[sf,od];incq[sf,oq]"), FCML_ASM_DIALECT_INSTRUCTION(F_INC, FCML_AM_RMO), 0 },
    { FCML_TEXT("inc"), FCML_ASM_DIALECT_INSTRUCTION(F_INC, FCML_AM_ALL), 0 },
    { FCML_TEXT("insb[tb,sb]"), FCML_ASM_DIALECT_INSTRUCTION(F_INS, FCML_AM_M8), 0 },
    { FCML_TEXT("insw[tb,sf,ow]"), FCML_ASM_DIALECT_INSTRUCTION(F_INS, FCML_AM_M16), 0 },
    { FCML_TEXT("insl[tb,sf,od]"), FCML_ASM_DIALECT_INSTRUCTION(F_INS, FCML_AM_M32), 0 },
    ...
    { FCML_TEXT("invlpga[tb]"), FCML_ASM_DIALECT_INSTRUCTION(F_INVLPGA, FCML_AM_ALL), 0 },
    { FCML_TEXT("invpcid"), FCML_ASM_DIALECT_INSTRUCTION(F_INVPCID, FCML_AM_ALL), 0 },
    { FCML_TEXT("iretw[sf,ow];iret[sf,od];iretq[sf,oq]"), FCML_ASM_DIALECT_INSTRUCTION(F_IRET, FCML_AM_ALL), 0 },
    ...
    { FCML_TEXT("lods;lodsb[tb,sb]"), FCML_ASM_DIALECT_INSTRUCTION(F_LODS, FCML_AM_RM8), 0 },
    { FCML_TEXT("lods;lodsw[tb,sf,ow];lodsl[tb,sf,od];lodsq[tb,sf,oq]"), FCML_ASM_DIALECT_INSTRUCTION(F_LODS, FCML_AM_RMO), 0 },
    ...
    { FCML_TEXT("monitor[tb]"), FCML_ASM_DIALECT_INSTRUCTION(F_MONITOR, FCML_AM_ALL), FCML_DO_NOT_INVERT_OPERANDS },
    ...
    { FCML_TEXT("movabs[aq];mov[aw];mov[ad]"), FCML_ASM_DIALECT_INSTRUCTION(F_MOV, FCML_AM_MOFF8_R8), 0 },
    { FCML_TEXT("movabs[aq];mov[aw];mov[ad]"), FCML_ASM_DIALECT_INSTRUCTION(F_MOV, FCML_AM_R8_MOFF8), 0 },
    { FCML_TEXT("movabs[aq];mov[aw];mov[ad]"), FCML_ASM_DIALECT_INSTRUCTION(F_MOV, FCML_AM_RO_MOFFO), 0 },
    { FCML_TEXT("movabs[aq];mov[aw];mov[ad]"), FCML_ASM_DIALECT_INSTRUCTION(F_MOV, FCML_AM_MOFFO_RO), 0 },
    ...
    { FCML_TEXT("movsb[tb,sb];movs"), FCML_ASM_DIALECT_INSTRUCTION(F_MOVS, FCML_AM_M8_M8), 0 },
    { FCML_TEXT("movs;movsw[tb,sf,ow];movsl[tb,sf,od];movsq[tb,sf,oq]"), FCML_ASM_DIALECT_INSTRUCTION(F_MOVS, FCML_AM_MO_MO), 0 },
    ...
    { FCML_TEXT("movsbw[sf,ow,d01,mm];movsbl[sf,od,d01,mm];movsbq[sf,oq,d01,mm];movsbw[sf,ow,mr];movsbl[sf,od,mr];movsbq[sf,oq,mr]"), FCML_ASM_DIALECT_INSTRUCTION(F_MOVSX, FCML_AM_RO_RM8), 0 },
    { FCML_TEXT("movsww[sf,ow,d02,mm];movswl[sf,od,d02,mm];movswq[sf,oq,d02,mm];movsww[sf,ow,mr];movswl[sf,od,mr];movswq[sf,oq,mr]"), FCML_ASM_DIALECT_INSTRUCTION(F_MOVSX, FCML_AM_RO_RM16), 0 },
    ...
    { FCML_TEXT("mulb[sb];mul"), FCML_ASM_DIALECT_INSTRUCTION(F_MUL, FCML_AM_RM8), 0 },
    { FCML_TEXT("mulw[sf,ow,mm];mull[sf,od,mm];mulq[sf,oq,mm];mul"), FCML_ASM_DIALECT_INSTRUCTION(F_MUL, FCML_AM_RMO), 0 },
    ...
    { FCML_TEXT("neg;negb[sb]"), FCML_ASM_DIALECT_INSTRUCTION(F_NEG, FCML_AM_RM8), 0 },
    { FCML_TEXT("neg;negw[sf,ow,mm];negl[sf,od,mm];negq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_NEG, FCML_AM_RMO), 0 },
    { FCML_TEXT("nop"), FCML_ASM_DIALECT_INSTRUCTION(F_NOP, FCML_AM_ALL), 0 },
    { FCML_TEXT("nop;nopw[sf,ow,mm];nopl[sf,od,mm];nopq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_NOP, FCML_AM_RMO), 0 },
    { FCML_TEXT("not;notb[sb]"), FCML_ASM_DIALECT_INSTRUCTION(F_NOT, FCML_AM_RM8), 0 },
    { FCML_TEXT("not;notw[sf,ow,mm];notl[sf,od,mm];notq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_NOT, FCML_AM_RMO), 0 },
    { FCML_TEXT("or"), FCML_ASM_DIALECT_INSTRUCTION(F_OR, FCML_AM_ALL), 0 },
    { FCML_TEXT("or;orb[sb,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_OR, FCML_AM_RM8_IMM8), 0 },
    { FCML_TEXT("or;orw[sf,ow,mm];orl[sf,od,mm];orq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_OR, FCML_AM_RMO_IMMO), 0 },
    { FCML_TEXT("or;orw[sf,ow,mm];orl[sf,od,mm];orq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_OR, FCML_AM_RMO_IMM8), 0 },
    ...
    { FCML_TEXT("outsb[tb,sb]"), FCML_ASM_DIALECT_INSTRUCTION(F_OUTS, FCML_AM_M8), 0 },
    { FCML_TEXT("outsw[tb,sf,ow]"), FCML_ASM_DIALECT_INSTRUCTION(F_OUTS, FCML_AM_M16), 0 },
    { FCML_TEXT("outsl[tb,sf,od]"), FCML_ASM_DIALECT_INSTRUCTION(F_OUTS, FCML_AM_M32), 0 },
    ...
    { FCML_TEXT("pop;popw[sf,ow,mm];popl[sf,od,mm];popq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_POP, FCML_AM_RMO), 0 },
    { FCML_TEXT("popw[ow];popl[od];popq[oq];pop"), FCML_ASM_DIALECT_INSTRUCTION(F_POP, FCML_AM_SR_FSGSO), 0 },
    { FCML_TEXT("pop"), FCML_ASM_DIALECT_INSTRUCTION(F_POP, FCML_AM_ALL), 0 },
    { FCML_TEXT("push;pushw[sf,ow,mm];pushl[sf,od,mm];pushq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_PUSH, FCML_AM_RMO), 0 },
    ...
    { FCML_TEXT("pushw[ow];pushl[od];pushq[oq];push"), FCML_ASM_DIALECT_INSTRUCTION(F_PUSH, FCML_AM_SR_FSGSO), 0 },
    { FCML_TEXT("push"), FCML_ASM_DIALECT_INSTRUCTION(F_PUSH, FCML_AM_ALL), 0 },
    { FCML_TEXT("popaw"), FCML_ASM_DIALECT_INSTRUCTION(F_POPA, FCML_AM_ALL), 0 },
    { FCML_TEXT("popa"), FCML_ASM_DIALECT_INSTRUCTION(F_POPAD, FCML_AM_ALL), 0 },
    { FCML_TEXT("popfw"), FCML_ASM_DIALECT_INSTRUCTION(F_POPF, FCML_AM_ALL), 0 },
    { FCML_TEXT("popfq"), FCML_ASM_DIALECT_INSTRUCTION(F_POPFQ, FCML_AM_ALL), 0 },
    { FCML_TEXT("popf"), FCML_ASM_DIALECT_INSTRUCTION(F_POPFD, FCML_AM_ALL), 0 },
    { FCML_TEXT("pushaw"), FCML_ASM_DIALECT_INSTRUCTION(F_PUSHA, FCML_AM_ALL), 0 },
    { FCML_TEXT("pusha"), FCML_ASM_DIALECT_INSTRUCTION(F_PUSHAD, FCML_AM_ALL), 0 },
    { FCML_TEXT("pushfw"), FCML_ASM_DIALECT_INSTRUCTION(F_PUSHF, FCML_AM_ALL), 0 },
    { FCML_TEXT("pushfq"), FCML_ASM_DIALECT_INSTRUCTION(F_PUSHFQ, FCML_AM_ALL), 0 },
    { FCML_TEXT("pushf"), FCML_ASM_DIALECT_INSTRUCTION(F_PUSHFD, FCML_AM_ALL), 0 },
    ...
    { FCML_TEXT("rcl;rclb[sb,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_RCL, FCML_AM_RM8), 0 },
    { FCML_TEXT("rcl;rclb[sb,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_RCL, FCML_AM_RM8_IMM8), 0 },
    { FCML_TEXT("rcl"), FCML_ASM_DIALECT_INSTRUCTION(F_RCL, FCML_AM_ALL), 0 },
    { FCML_TEXT("rcr;rcrw[sf,ow,mm];rcrl[sf,od,mm];rcrq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_RCR, FCML_AM_RMO), 0 },
    { FCML_TEXT("rcr;rcrw[sf,ow,mm];rcrl[sf,od,mm];rcrq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_RCR, FCML_AM_RMO_IMM8), 0 },
    { FCML_TEXT("rcr;rcrb[sb,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_RCR, FCML_AM_RM8), 0 },
    { FCML_TEXT("rcr;rcrb[sb,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_RCR, FCML_AM_RM8_IMM8), 0 },
    { FCML_TEXT("rcr"), FCML_ASM_DIALECT_INSTRUCTION(F_RCR, FCML_AM_ALL), 0 },
    { FCML_TEXT("rol;rolw[sf,ow,mm];roll[sf,od,mm];rolq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_ROL, FCML_AM_RMO), 0 },
    { FCML_TEXT("rol;rolw[sf,ow,mm];roll[sf,od,mm];rolq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_ROL, FCML_AM_RMO_IMM8), 0 },
    { FCML_TEXT("rol;rolb[sb,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_ROL, FCML_AM_RM8), 0 },
    { FCML_TEXT("rol;rolb[sb,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_ROL, FCML_AM_RM8_IMM8), 0 },
    { FCML_TEXT("rol"), FCML_ASM_DIALECT_INSTRUCTION(F_ROL, FCML_AM_ALL), 0 },
    { FCML_TEXT("ror;rorw[sf,ow,mm];rorl[sf,od,mm];rorq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_ROR, FCML_AM_RMO), 0 },
    { FCML_TEXT("ror;rorw[sf,ow,mm];rorl[sf,od,mm];rorq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_ROR, FCML_AM_RMO_IMM8), 0 },
    { FCML_TEXT("ror;rorb[sb,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_ROR, FCML_AM_RM8), 0 },
    { FCML_TEXT("ror;rorb[sb,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_ROR, FCML_AM_RM8_IMM8), 0 },
    { FCML_TEXT("ror"), FCML_ASM_DIALECT_INSTRUCTION(F_ROR, FCML_AM_ALL), 0 },
    { FCML_TEXT("retw[ow];ret[od];retq[oq]"), FCML_ASM_DIALECT_INSTRUCTION(F_RET, FCML_AM_ALL), 0 },
    { FCML_TEXT("lretw[ow];lret[od];lretq[oq]"), FCML_ASM_DIALECT_INSTRUCTION(F_RETF, FCML_AM_ALL), 0 },
    ...
    { FCML_TEXT("sar;sarw[sf,ow,mm];sarl[sf,od,mm];sarq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_SAR, FCML_AM_RMO), 0 },
    { FCML_TEXT("sar;sarw[sf,ow,mm];sarl[sf,od,mm];sarq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_SAR, FCML_AM_RMO_IMM8), 0 },
    { FCML_TEXT("sar;sarb[sb,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_SAR, FCML_AM_RM8), 0 },
    { FCML_TEXT("sar;sarb[sb,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_SAR, FCML_AM_RM8_IMM8), 0 },
    { FCML_TEXT("sar"), FCML_ASM_DIALECT_INSTRUCTION(F_SAR, FCML_AM_ALL), 0 },
    { FCML_TEXT("shl;shlw[sf,ow,mm];shll[sf,od,mm];shlq[sf,oq,mm];salw[sf,ow,mm];sall[sf,od,mm];salq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_SHL, FCML_AM_RMO), 0 },
    { FCML_TEXT("shl;shlw[sf,ow,mm];shll[sf,od,mm];shlq[sf,oq,mm];salw[sf,ow,mm];sall[sf,od,mm];salq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_SHL, FCML_AM_RMO_IMM8), 0 },
    { FCML_TEXT("shl;shlb[sb,mm];sal;salb[sb,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_SHL, FCML_AM_RM8), 0 },
    { FCML_TEXT("shl;shlb[sb,mm];sal;salb[sb,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_SHL, FCML_AM_RM8_IMM8), 0 },
    { FCML_TEXT("shl;sal"), FCML_ASM_DIALECT_INSTRUCTION(F_SHL, FCML_AM_ALL), 0 },
    { FCML_TEXT("shr;shrw[sf,ow,mm];shrl[sf,od,mm];shrq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_SHR, FCML_AM_RMO), 0 },
    { FCML_TEXT("shr;shrw[sf,ow,mm];shrl[sf,od,mm];shrq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_SHR, FCML_AM_RMO_IMM8), 0 },
    { FCML_TEXT("shr;shrb[sb,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_SHR, FCML_AM_RM8), 0 },
    { FCML_TEXT("shr;shrb[sb,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_SHR, FCML_AM_RM8_IMM8), 0 },
    ...
    { FCML_TEXT("sbb;sbbb[sb]"), FCML_ASM_DIALECT_INSTRUCTION(F_SBB, FCML_AM_RM8_IMM8), 0 },
    { FCML_TEXT("sbb;sbbw[sf,ow,mm];sbbl[sf,od,mm];sbbq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_SBB, FCML_AM_RMO_IMMO), 0 },
    { FCML_TEXT("sbb;sbbw[sf,ow,mm];sbbl[sf,od,mm];sbbq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_SBB, FCML_AM_RMO_IMM8), 0 },
    { FCML_TEXT("scas;scasb[tb,sb]"), FCML_ASM_DIALECT_INSTRUCTION(F_SCAS, FCML_AM_RM8), 0 },
    { FCML_TEXT("scas;scasw[tb,sf,ow];scasl[tb,sf,od];scasq[tb,sf,oq]"), FCML_ASM_DIALECT_INSTRUCTION(F_SCAS, FCML_AM_RMO), 0 },
    { FCML_TEXT("set"), FCML_ASM_DIALECT_INSTRUCTION(F_SET, FCML_AM_ALL), 0 },
    { FCML_TEXT("stos;stosb[tb,sb]"), FCML_ASM_DIALECT_INSTRUCTION(F_STOS, FCML_AM_RM8), 0 },
    { FCML_TEXT("stos;stosw[tb,sf,ow];stosl[tb,sf,od];stosq[tb,sf,oq]"), FCML_ASM_DIALECT_INSTRUCTION(F_STOS, FCML_AM_RMO), 0 },
    { FCML_TEXT("sub"), FCML_ASM_DIALECT_INSTRUCTION(F_SUB, FCML_AM_ALL), 0 },
    { FCML_TEXT("sub;subb[sb]"), FCML_ASM_DIALECT_INSTRUCTION(F_SUB, FCML_AM_RM8_IMM8), 0 },
    { FCML_TEXT("sub;subw[sf,ow,mm];subl[sf,od,mm];subq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_SUB, FCML_AM_RMO_IMMO), 0 },
    { FCML_TEXT("sub;subw[sf,ow,mm];subl[sf,od,mm];subq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_SUB, FCML_AM_RMO_IMM8), 0 },
    ...
    { FCML_TEXT("test;testb[sb]"), FCML_ASM_DIALECT_INSTRUCTION(F_TEST, FCML_AM_RM8_IMM8), 0 },
    { FCML_TEXT("test;testw[sf,ow,mm];testl[sf,od,mm];testq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_TEST, FCML_AM_RMO_IMMO), 0 },
    { FCML_TEXT("test;testw[sf,ow,mm];testl[sf,od,mm];testq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_TEST, FCML_AM_RMO_IMM8), 0 },
    ...
    { FCML_TEXT("vmload[tb]"), FCML_ASM_DIALECT_INSTRUCTION(F_VMLOAD, FCML_AM_ALL), 0 },
    { FCML_TEXT("vmrun[tb]"), FCML_ASM_DIALECT_INSTRUCTION(F_VMRUN, FCML_AM_ALL), 0 },
    { FCML_TEXT("vmsave[tb]"), FCML_ASM_DIALECT_INSTRUCTION(F_VMSAVE, FCML_AM_ALL), 0 },
    ...
    { FCML_TEXT("vcvtqq2ps[l2];vcvtqq2psx[l0];vcvtqq2psy[l1]"), FCML_ASM_DIALECT_INSTRUCTION(F_VCVTQQ2PS, FCML_AM_ALL), 0 },
    ...
    { FCML_TEXT("xlat[tb,sb];xlatb[tb,sb]"), FCML_ASM_DIALECT_INSTRUCTION(F_XLAT, FCML_AM_ALL), 0 },
    { FCML_TEXT("xor"), FCML_ASM_DIALECT_INSTRUCTION(F_XOR, FCML_AM_ALL), 0 },
    { FCML_TEXT("xor;xorb[sb]"), FCML_ASM_DIALECT_INSTRUCTION(F_XOR, FCML_AM_RM8_IMM8), 0 },
    { FCML_TEXT("xor;xorw[sf,ow,mm];xorl[sf,od,mm];xorq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_XOR, FCML_AM_RMO_IMMO), 0 },
    { FCML_TEXT("xor;xorw[sf,ow,mm];xorl[sf,od,mm];xorq[sf,oq,mm]"), FCML_ASM_DIALECT_INSTRUCTION(F_XOR, FCML_AM_RMO_IMM8), 0 },
    ...
    { FCML_TEXT("xsavec"), FCML_ASM_DIALECT_INSTRUCTION(F_XSAVEC, FCML_AM_ALL), 0 },
    { FCML_TEXT("xsave64"), FCML_ASM_DIALECT_INSTRUCTION(F_XSAVE64, FCML_AM_ALL), 0 },
    { FCML_TEXT("xsavec64"), FCML_ASM_DIALECT_INSTRUCTION(F_XSAVEC64, FCML_AM_ALL), 0 },
...
fcml_string fcml_ar_asm_dialect_reg_symbol_table_gas[16] = {
        FCML_TEXT("db0"), FCML_TEXT("db1"), FCML_TEXT("db2"),
        FCML_TEXT("db3"), FCML_TEXT("db4"), FCML_TEXT("db5"),
        FCML_TEXT("db6"), FCML_TEXT("db7"), FCML_TEXT("<unknown DB>"),
        FCML_TEXT("<unknown DB>"), FCML_TEXT("<unknown DB>"),
        FCML_TEXT("<unknown DB>"), FCML_TEXT("<unknown DB>"),
        FCML_TEXT("<unknown DB>"), FCML_TEXT("<unknown DB>"),
        FCML_TEXT("<unknown DB>")
};
...
static fcml_ceh_error get_register(const fcml_st_register *reg,
    ...
    fcml_fn_env_str_snprintf(buffer, buffer_length, FCML_TEXT("%%%s"),
            printable_reg);
...
static fcml_ceh_error get_parsed_mnemonics(const fcml_st_dialect *dialect,
    ...
    fcml_size num_keys = sizeof(keys) / sizeof(fcml_uint32_t);

    for (int i = 0; i < num_keys && !mnemonic_pattern; i++) {

        fcml_st_dialect_mnemonic *dialect_mnemonic = (fcml_st_dialect_mnemonic*)
        ...
        if (dialect_mnemonic) {
            ...
            /* Check if this mnemonics set is available for current
             * dialect configuration. */
            ignore |= (dialect_context->config_flags &
                    FCML_GAS_DIALECT_CF_SYSV_SVR32_INCOMPATIBLE) &&
                            (dialect_mnemonic->flags &
                                    FCML_SYSV_SVR32_COMPATIBLE);
            if (!ignore) {
    ...
    fcml_ceh_error error = fcml_fn_mp_parse_mnemonics(mnemonic_pattern,
            mnemonics);
...
static fcml_ceh_error get_mnemonic(const fcml_st_dialect *dialect,
    ...
    error = get_parsed_mnemonics(dialect, instruction,
            addr_mode, &mnemonic_set);
    if (!error) {
...
static void invert_operands(fcml_st_operand *operands, fcml_int count) {
...
/* Correction for ambiguous FAR_POINTER addressing mode. Unfortunately we
 * can not treat it as two IMM operands.
 */
static fcml_bool correct_far_pointer(fcml_st_instruction *instruction) {

    fcml_ceh_error error = FCML_CEH_GEC_NO_ERROR;

    if (instruction->operands_count == 2 && instruction->operands[0].type ==
            FCML_OT_IMMEDIATE && instruction->operands[1].type ==
                    FCML_OT_IMMEDIATE) {
        ...
        if (!error) {
            ...
            if (!error) {
                /* Clean operands.*/
                fcml_fn_env_memory_clear(instruction->operands,
...
static fcml_ceh_error asm_preprocessor(const fcml_st_dialect *dialect,
        const fcml_st_def_addr_mode_desc *addr_mode_desc,
        const fcml_st_mp_mnemonic *mnemonic, fcml_en_instruction inst_code,
        fcml_st_instruction *inst, fcml_bool *inst_changed) {
    ...
    if (!mnemonic) {
        ...
        if (inst->operands_count > 1) {
            invert_operands(inst->operands, inst->operands_count);
            changed = FCML_TRUE;
        }
    } else {
        /* For bound and enter instructions operands should be provided in
           the same order as for Intel assembler, so they should be reverted
           one more time. We can gain some performance by doubling this
           operation for these two instructions instead of reverting operands
           for any checked addressing mode. But for now such a solution is
           acceptable. */
        if (mnemonic->flags & FCML_DO_NOT_INVERT_OPERANDS) {
            invert_operands(inst->operands, inst->operands_count);
            changed = FCML_TRUE;
        }
        /* Mnemonic has been found, check if data size should be corrected
           for instruction. Take into account that data size specified by
        ...
        if (data_size != FCML_DS_UNDEF) {
            /* Find effective address and make a correction to the size operator.
               In the future size operator should be moved to the instruction
               itself, because there is always only one memory access for the
               instruction. */
            for (int i = 0; i < inst->operands_count; i++) {

                fcml_st_operand *operand = &(inst->operands[i]);
        ...
        if (addr_mode_desc) {
            if (FCML_IS_ADDR_MODE(addr_mode_desc->operands[0], FCML_OP_FAR_POINTER)) {
                /* Prepare operands. */
                if (inst->operands_count == 2 &&
                        inst->operands[0].type == FCML_OT_IMMEDIATE &&
                        inst->operands[1].type == FCML_OT_IMMEDIATE) {
                    if (correct_far_pointer(inst)) {
                        changed = FCML_TRUE;
                    }
                }
            }
        ...
        /*
         * In case of AT&T dialect, offsets encoded as effective addresses of
         * type OFFSET are always treated as direct pointers. It means that
         * every time you encode offset as effective address of FCML_AF_OFFSET
         * type it'll be encoded as an indirect pointer (as long as the
         * instruction level FCML_HINT_INDIRECT_POINTER hint isn't used).
         * This rule is used to make AT&T parser, where the offset operands
         * are treated as direct pointers and indirect ones have the
         * appropriate hint always set, works as expected.
         */

        /* JMP and CALL needs hint FCML_HINT_DIRECT_POINTER explicitly set if
         * absolute offsets are used instead of immediate values.
         */
        if (inst_code == F_JMP || inst_code == F_CALL) {
            if (!(inst->hints & FCML_HINT_INDIRECT_POINTER)) {
                inst->hints = FCML_HINT_DIRECT_POINTER;
                changed = FCML_TRUE;
            }
        }
    }
...
static fcml_ceh_error disasm_postprocessor(const fcml_st_mp_mnemonic *mnemonic,
    ...
    if (operands_count > 1) {
        if (!(mnemonic->flags & FCML_DO_NOT_INVERT_OPERANDS)) {
            /* Revert operands.*/
            invert_operands(disassembler_result->instruction.operands,
                    operands_count);

            /* Revert operand details.*/
            fcml_st_operand_details *details =
                    disassembler_result->instruction_details.operand_details;
            fcml_st_operand_details tmp_details;
            fcml_int i;
            for (i = 0; i < operands_count / 2; i++) {
                tmp_details = details[i];
                details[i] = details[operands_count - i - 1];
                details[operands_count - i - 1] = tmp_details;
            }
        }
    }
...
static fcml_st_dialect_pseudo_op_mnemonic pseudo_op_mnemonic_gas[] = {
        { ".byte", FP_DB }, { NULL, FP_NO_PSEUDO_OP }
};

static fcml_st_dialect_pseudo_op_mnemonic *get_pseudo_op_mnemonics(void) {
    return &pseudo_op_mnemonic_gas[0];
}

fcml_ceh_error LIB_CALL fcml_fn_dialect_init_gas(fcml_uint32_t config_flags,
        fcml_st_dialect **dialect) {

    fcml_ceh_error error = FCML_CEH_GEC_NO_ERROR;
    fcml_st_dialect_context_int *dialect_context_gas = NULL;

    error = fcml_fn_asm_dialect_alloc_mnemonic_lookup(&dialect_context_gas,
            fcml_arr_dialect_gas_mnemonics,
            sizeof(fcml_arr_dialect_gas_mnemonics) /
    ...
    dialect_context_gas->get_mnemonic = &get_mnemonic;
    dialect_context_gas->get_pseudo_op_mnemonics = &get_pseudo_op_mnemonics;
    dialect_context_gas->get_pseudo_op_mnemonic = &get_pseudo_op_mnemonic;
    dialect_context_gas->get_parsed_mnemonics = &get_parsed_mnemonics;
    ...
    /* This method should be available in renderer, but having it here
     * can be useful in the future.*/
    dialect_context_gas->get_register = &get_register;
    dialect_context_gas->asm_preprocessor = &asm_preprocessor;
    dialect_context_gas->disasm_postprocessor = &disasm_postprocessor;
    dialect_context_gas->config_flags = config_flags;

    *dialect = (fcml_st_dialect*) dialect_context_gas;
